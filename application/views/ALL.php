...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Layanan Informasi Rumah Ibadah - Kantor Kementerian Agama Kota Sawahlunto</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('app-assets/css/pages/dashboard-ico.css')?>">
...
<div class="navbar-header d-md-none">
    ...
    <li class="nav-item d-md-none"><a class="navbar-brand" href="index.html"><img class="brand-logo d-none d-md-block" alt="CryptoDash admin logo" src="<?= base_url('app-assets/images/logo/logo.png')?>"><img class="brand-logo d-sm-block d-md-none" alt="CryptoDash admin logo sm" src="<?= base_url('app-assets/images/logo/logo-sm.png')?>"></a></li>
...
<div class="navbar-container">
    ...
    <ul class="nav navbar-nav mr-auto float-left">
        ...
        <li style="display: none;" class="nav-item nav-search">
        ...
        <li class="nav-item nav-search">
            <h1 class="mt-2">LAYANAN INFORMASI RUMAH IBADAH</h1>
        </li>
    </ul>
    <ul class="nav navbar-nav float-right">         
        <li style="display: none;" class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-gb"></i><span class="selected-language"></span></a>
        <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="#"><i class="flag-icon flag-icon-gb"></i> English</a><a class="dropdown-item" href="#"><i class="flag-icon flag-icon-fr"></i> French</a><a class="dropdown-item" href="#"><i class="flag-icon flag-icon-cn"></i> Chinese</a><a class="dropdown-item" href="#"><i class="flag-icon flag-icon-de"></i> German</a></div>
        </li>
        <li style="display: none;" class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i><span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">5</span></a>
        ...
        <li style="display: none;" class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="wallet.html"><i class="ficon icon-wallet"></i></a></li>
...
<div class="main-menu-content"><a class="navigation-brand d-none d-md-block d-lg-block d-xl-block" href="index.html"><img class="brand-logo" alt="CryptoDash admin logo" src="<?= base_url('app-assets/images/logo/logo.png')?>" /></a>
<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li class=" nav-item"><a href="buy-ico.html"><i class="icon-layers"></i><span class="menu-title" data-i18n="">Data</span></a>
    </li>
    <li class=" nav-item"><a href="wallet.html"><i class="icon-graph"></i><span class="menu-title" data-i18n="">Statistik</span></a>
    </li>
    <li class=" nav-item"><a href="faq.html"><i class="icon-question"></i><span class="menu-title" data-i18n="">FAQ</span></a>
    </li>
    <li class=" nav-item" style="display: none;"><a href="#"><i class="icon-user-following"></i><span class="menu-title" data-i18n="">Account</span></a>
...
<div class="app-content content">
    <div class="content-wrapper">
        ...
        <div class="content-body"><!-- ICO Token &  Distribution-->
            <div class="row match-height">
                <div class="col-12">
                    <div class="jumbotron p-3 p-md-5 text-dark rounded bg-transparent">
                        <div class="col-md-8 px-0">
                        <h1 class="display-6 font-italic">Selamat Datang di Layanan Informasi Rumah Ibadah</h1>
                        <h3 class="display-6 font-italic">Kantor Kementerian Agama Kota Sawahlunto</h3>
                        <p class="lead my-e">
                            Temukan kemudahan untuk menemukan rumah ibadah di sekitar anda ketika berada di Kota Sawahlunto. Kami menyediakan informasi lengkap tentang berbagai rumah ibadah yang ada. Dengan sistem pencarian yang mudah dan informasi yang terperinci. Anda dapat menemukan tempat ibadah sesuai dengan kebutuhan Anda, mulai dari informasi detail, contact person, hingga peta lokasi yang tersedia.
                        </p>
                        <p class="lead my-e">
                            Fitur Unggulan Kami :
                            <ul>
                                <li><strong>Pencarian Lokasi Rumah Ibadah</strong> : Cari rumah ibadah berdasarkan lokasi atau nama tempat ibadah yang anda inginkan</li>
                                <li><strong>Jadwal Ibadah</strong> : Dapatkan informasi terbaru mengenai jadwal ibadah, kegiatan rohani dan acara khusus</li>
                                <li><strong>Fasilitas dan Aksesibilitas</strong> : Temukan informasi terkait fasilitas yang tersedia, seperti tempat parkir, akses bagi ibu menyusui dan kenyamanan lainnya</li>
                                <li><strong>Statistik</strong> : Anda dapat melihat grafik statistik terkait dengan data rumah ibadah</li>
                            </ul>
                        </p>
            ...
            <div class="row match-height">
                <div class="col-xl-4 col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <img class="img-fluid" src="<?= base_url('app-assets/images/pages/blog-post.png')?>" alt="Card image cap">
                            <div class="card-body">
    ...
    <!-- END MODERN JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?= base_url('app-assets/js/scripts/pages/dashboard-ico.js')?>" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>