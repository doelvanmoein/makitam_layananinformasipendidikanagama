      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Data Rumah Ibadah</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?= base_url() ?>">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item active">Data Rumah Ibadah
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="content-body">
            <div id="transactions">
                    ...
                    <div class="col-12">
                        <div class="row px-1">
                            <div class="col-md-2 col-12 py-1">
                                <p class="mb-0">Nama Rumah Ibadah</p>
                            </div>
                            <div class="col-md-2 col-12 py-1">
                ...
                <div class="transactions-table-tbody">
                    ...
                    <?php else : ?>
                    <?php foreach ($worshiphouseList as $key => $val) : ?>
                    <section class="card pull-up">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="row info-worshiphouse" data-id="<?= $val['worshiphouse_id'] ?>" data-url="<?= base_url('Home/detail/').$val['worshiphouse_id'] ?>" data-toggle="modal" data-target="#ModalDetail" style="cursor: pointer;">
                                        <div class="col-md-2 col-12 py-1">
                                            <p class="mb-0"><?= $val['worshiphouse_name'] ?></p>
                                        </div>
                                        <div class="col-md-2 col-12 py-1">
                                            <p class="mb-0"><?= $arr_worshiphouse_type[$val['worshiphouse_worshiphousetype_id']] ?></p>
                                        </div>
                                        <div class="col-md-2 col-12 py-1">
                                            <p class="mb-0"><?= $arr_religion[$val['worshiphouse_religion']] ?></p>
                                        </div>
                                        <div class="col-md-1 col-12 py-1">
                                            <p class="mb-0"><?= $val['kec_name'] ?></p>
                                        </div>
                                        <div class="col-md-2 col-12 py-1">
                                            <p class="mb-0"><?= $val['kel_name'] ?></p>
                                        </div>
                                        <div class="col-md-3 col-12 py-1">
                                            <p class="mb-0"><?= $val['worshiphouse_address'] ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
